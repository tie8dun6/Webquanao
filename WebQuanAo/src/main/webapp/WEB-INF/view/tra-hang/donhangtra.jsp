...
<%--            <form:form class="w3-container" action="/trahang/{id}" method="post" modelAttribute="traHang">--%>

<%--                <form:input class="form-control" path="id"></form:input>--%>
<%--                <br>--%>
<%--                <form:input class="form-control" path="idChiTietSanPham.ten"></form:input>--%>
<%--                <br>--%>
<%--                <form:input class="form-control" path="soLuong"></form:input>--%>
<%--                <br>--%>
<%--                <form:input class="form-control" path="donGia"></form:input>--%>
