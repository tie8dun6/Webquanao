         ...
         <img src="../../../img/${image}" width="300" height="300">
            ...
            <div class="col-lg-6">
              ...
              <div class="w3-container">
                <form:form class="w3-container" action="/chi-tiet-san-pham/add" method="post" modelAttribute="chiTietSPDTO" enctype="multipart/form-data">
