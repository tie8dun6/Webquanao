...
<%--                                                            </td>--%>
<%--&lt;%&ndash;                                                            <td><a class="btn btn-sm btn-warning"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                   onclick="return confirm('Bạn chắc chắn xóa chứ ?')"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                                   href="/mau-sac/delete/${ms.id}?trangThai=4">Delete</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                                            </td>&ndash;%&gt;--%>
<%--                                                            </td>--%>
                                                        </tr>
                                                    </c:forEach>
